...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        @include('admin.partials.content-header',['name' => 'Products', 'key' => 'Edit','url' => route('products')])
        <!-- /.content-header -->
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="div col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h1 class="card-title">Edit Product</h1><br>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                       ...
                                                       value="{{old('name', $product->name)}}" required max="255">
                                                @error('name')
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number"
                                                       ...
                                                       placeholder="800000" name="sale_price" min="0" step="10000"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number"
                                                       ...
                                                       placeholder="1000000" name="price" min="0" step="10000"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control @error('intro') is-invalid @enderror"
                                                          id="intro"
                                                          rows="5" name="intro">{{old('intro', $product->intro)}}</textarea>
                                                @error('intro')
                                                <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                       ...
                                                       placeholder="Red, Brown" name="color" value="{{old('color',$product->color)}}">
                                                @error('color')
                                                <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <select class="tags_select2 form-control" multiple="multiple"
                                                    ...
                                                    @foreach($tags as $tag)
                                                        <option value="{{$tag->name}}" {{ $selectedTags->pluck('tags.id')->contains($tag->id) ? 'selected' : '' }}>
                                                            {{$tag->name}}
                                                        </option>
                                                    @endforeach
                                                </select>
    ...
    <script>
        ...
        $('#selectSizes')
            .on('select2:select', function (e) {
                console.log('function triggered 319');
                ...
                selectedSizeIds.forEach(sizeId => {
                    if (!existingInputFields[sizeId]) {
                        createQuantityInputField(sizeId, sizeName, {{ $product->id }}); // Create input field if it doesn't exist
                    }
                });
            })
        ...
        // function to pre-select size option


        $(window).on("load", function() {
            const preselectedSizes = {!! json_encode($selectedSizes->pluck('sizes.id')->toArray()) !!};
            console.log(preselectedSizes);
            console.log(preselectedSizes);
            const selectSizes = document.getElementById('selectSizes');
            $('#selectSizes').val(preselectedSizes).trigger('change');
            console.log( typeof preselectedSizes[0]);

            preselectedSizes.forEach(sizeId => {
                const option = selectSizes.querySelector(`option[value="${sizeId}"]`);
                if (option) {
                var sizeName = $(option).text();
                createQuantityInputField(sizeId, sizeName, {{ $product->id }});
                }
            });
        });
        // function selectSize(sizeId, sizeText, element) {
        //     // Set the value programmatically
        //     $('#selectSizes').val(sizeId).trigger('change');
        //
        ...
        //     };
        //
        //     // Manually trigger the select2:select event with parameters
        //     var event = new $.Event('select2:select', { params: { data: selectedData } });
        //     $('#selectSizes').trigger(event);
        // }
        ...
        $(window).on("load", function() {
            console.log('load');
            console.log(existingInputFields);
        });
    </script>
@endsection
