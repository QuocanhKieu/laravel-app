...
@section('content')
    <div class="content-wrapper">
        ...
        @include('admin.partials.content-header',['name' => 'Categories', 'key' => 'Add','url' => route('categories')])
        <!-- /.content-header -->
                            ...
                            <div class="card-body">
                                ...
                                <form action='{{route('categories.store')}}' method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="catName" aria-describedby="catName"
